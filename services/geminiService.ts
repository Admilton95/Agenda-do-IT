...
const getSystemInstruction = (role: AgentRole): string => {
  ...
  switch (role) {
    ...
    case AgentRole.OPERATIONAL:
      return `${base} Seu foco é a execução técnica, rotas e estimativas de tempo. Ao receber um relatório de trabalho, use a ferramenta 'logWorkDone' para registrar imediatamente.`;
